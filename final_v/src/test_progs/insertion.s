...
iloop:
  ldq $r3, 0($r9) #temp = a[i] #90
  mov $r5,$r6     #j = i #94 
  mov $r9,$r19     #index j #98
  subq $r19,8,$r18 #index j-1 #9c
jloop:
  ldq $r14, 0($r18) #r14 = a[j-1] #a0
  ldq $r15, 0($r19) #r15 = a[j] #a4

  cmpult $r14,$r3, $r11 #a8       
  bne $r11,ifinish #ac
