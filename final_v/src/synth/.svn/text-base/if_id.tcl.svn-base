...
#/* new design                                              */
#/***********************************************************/
read_file -f ddc [list "if_stage.ddc" "id_stage.ddc" "prefetch.ddc"]
set_dont_touch if_stage
set_dont_touch id_stage
set_dont_touch prefetch
read_file -f verilog [list "../sys_defs.vh" "../verilog/if_id.v"]
set design_name if_id
