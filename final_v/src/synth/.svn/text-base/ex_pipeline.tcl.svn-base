...
#/* new design                                              */
#/***********************************************************/
read_file -f ddc [list "alu_all.ddc"]
set_dont_touch alu_all
read_file -f ddc [list "mult_decoder.ddc"]
set_dont_touch mult_decoder
read_file -f verilog [list "../sys_defs.vh" "../verilog/ex_stage/ex_pipeline.v"]
set design_name ex_pipeline
