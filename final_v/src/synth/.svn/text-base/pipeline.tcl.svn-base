...
read_file -f ddc [list "pipe_mult.ddc"]
set_dont_touch pipe_mult
read_file -f verilog [list "../sys_defs.vh" "../verilog/cachecontroller.v" "../verilog/cache.v" "../verilog/BTB.v" "../verilog/if_stage.v" "../verilog/id_stage.v" "../verilog/if_id.v" "../verilog/archtable.v" "../verilog/rob.v" "../verilog/pr.v" "../verilog/rs2.v" "../verilog/ex_stage/alu.v" "../verilog/ex_stage/ex_pipeline.v" "../verilog/ex_stage/mult_decoder.v" "../verilog/maptable.v" "../verilog/freelist.v" "../verilog/pipeline.v" "../verilog/prefetch.v" "../verilog/ldq.v" "../verilog/stq.v" "../verilog/rob_connect.v" "../verilog/bs.v"]
