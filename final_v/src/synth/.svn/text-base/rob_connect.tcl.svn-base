...
set_dont_touch rob
read_file -f ddc [list "archtable.ddc"]
set_dont_touch archtable
read_file -f ddc [list "maptable.ddc"]
set_dont_touch maptable
read_file -f ddc [list "freelist.ddc"]
set_dont_touch freelist
read_file -f ddc [list "bs.ddc"]
set_dont_touch bs
read_file -f verilog [list "../sys_defs.vh" "../verilog/rob_connect.v"]
set design_name rob_connect
...
#/***********************************************************/
set SYN_DIR ./
set search_path "/afs/engin.umich.edu/caen/generic/mentor_lib-D.1/public/eecs470/synopsys/"
